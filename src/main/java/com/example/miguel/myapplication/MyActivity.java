...
public class MyActivity extends AppCompatActivity {
    ...
    EditText aptName,aptMaxGuests,aptSize;
 ...
 FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
        ...
        aptMaxGuests = (EditText) findViewById(R.id.aptMaxGuests);
        aptSize = (EditText) findViewById(R.id.aptSize);
